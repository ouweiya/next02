    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
            <main className="w-full max-w-3xl px-6 py-24 sm:px-10">
                <h1 className="text-3xl font-semibold tracking-tight text-black dark:text-zinc-50 bg-red-200">
                    App Router - 简单演示主页-123
                </h1>
            ...
            <div className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
              /blog
                    ...
                    <Link
                        ...
                        <div className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">/counter</div>
                    </Link>
                    ...
                    <Link
                        ...
                        <div className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">/demo-one</div>
                    </Link>
                    ...
                    <Link
                        ...
                        <div className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">/demo-two</div>
                    </Link>
                </nav>
            </main>
        </div>
